   ...
   <?php include("components/client_logo.php") ?>
   ...
   <?php include("components/services.php") ?>
               ...
               <div class="col-lg-7">
                  <div class="about-conent paragraph">
                     ...
                     <div class="item-pair mt40 wow fadeIn" data-wow-delay=".6s" data-wow-duration="1500ms">
                        <a href="https://separateweb.com/" class="sw-btn sw-blue-btn">Get Started</a>
               ...
               <div class="col-lg-5 mmt40">
                  <div class="img-collage-set row">
                     ...
                     <div class="col-6 index-up">
                        <div class="imgcover roundimg shadow"> <img src="images/common/office-3.jpg" alt="img"></div>
                     </div>
                     <div class="col-6 index-up mt60">
                        <div class="imgcover roundimg shadow"> <img src="images/common/office-4.jpg" alt="img"></div>
                     </div>
      ...
      <!--star work slide block -->
      <section class="word-block-div section-space white-bg black-bg-0">
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
                  <h2 class="text-gradient-1">Latest Projects</h2>
                  <a href="portfolio.html" class="inline-btn mt20">View all Projects <i class="fa-solid fa-arrow-trend-up"></i></a>
               </div>
               <div class="col-lg-6 mmt30">
                  <p>Blueket overcomes challenges, achieves results, and adds value to our clients and partners. Take a look at some of our clients' success stories. Take a look at some of our clients' success stories.</p>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row justify-content-between v-center">
               ...
               <div class="col-lg-6 mmt40">
                  ...
                  <h4>Why Hire The Blueket As Your Mobile App Development Company?</h4>
      ...
      <!-- block -->
      <section class="whywe section-space bg-efffect-1 bkbg3">
         <div class="container index-up">
            <div class="row">
               <div class="col-lg-10">
                  <span class="scriptheading dashbefore mb15">Why Blueket?</span>
                  <h2 class="text-gradient-1">Why Choose Blueket For Web Development?</h2>
               </div>
            </div>
            <div class="row justify-content-between mt30">
              ...
              <div class="col-lg-3 col-sm-6 mt30">
                <div class="sw-card white-bg shadow">
                  <div class="cardicon"><img src="images/icons/analyz.png" alt="icon"></div>
                  <h4>Analyze Project</h4>
                  <p>We prioritise studying your project, brand, status, and future goals. The first goal will be to locate your competitors.</p>                  
                </div>
              </div>

              <div class="col-lg-3 col-sm-6 mt30">
                <div class="sw-card white-bg shadow">
                  <div class="cardicon"><img src="images/icons/idea.png" alt="icon"></div>
                  <h4>Unique Ideas</h4>
                  <p>We prioritise studying your project, brand, status, and future goals. The first goal will be to locate your competitors.</p>                  
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6 mt30">
                <div class="sw-card white-bg shadow">
                  <div class="cardicon"><img src="images/icons/optimization.png" alt="icon"></div>
                  <h4>Optimization</h4>
                  <p>We prioritise studying your project, brand, status, and future goals. The first goal will be to locate your competitors.</p>                  
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6 mt30">
                <div class="sw-card white-bg shadow">
                  <div class="cardicon"><img src="images/icons/technical-support.png" alt="icon"></div>
                  <h4> Support</h4>
                  <p>We prioritise studying your project, brand, status, and future goals. The first goal will be to locate your competitors.</p>                  
                </div>
              </div>
      ...
      <!-- news and blogs -->
      <section class="newsandblogs section-space bkbg3">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  ...
                  <a href="blogs-details.html">
                     <div class="swbluketcard animation">
                        <div class="div-card-img-info">
                           ...
                           <div class="img-div-sw-bkt"><img src="images/blogs/uiuxdesign.jpg" alt="blogs"></div>
                  ...
                  <a href="blogs-details.html">
                     <div class="swbluketcard animation">
                        <div class="div-card-img-info">
                           ...
                           <div class="img-div-sw-bkt"><img src="images/blogs/marketing.jpg" alt="blogs"></div>
                           <div class="info-div-sw-btk">
                  ...
                  <a href="blogs-details.html">
                     <div class="swbluketcard animation">
                        <div class="div-card-img-info">
                           ...
                           <div class="img-div-sw-bkt"><img src="images/blogs/app-design.jpg" alt="blogs"></div>
                           <div class="info-div-sw-btk">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-4">
            <div class="footer-brand-info">
              ...
              <div class="career-link-btn-sw mt60">
                <span class="linktitle">Career</span>
                <a href="#">
                  <div class="carrerlinkandimg mt10"><img src="images/icons/career.png" alt="career" class="w32">We’re Hiring!</div>
                </a>
              </div>
      ...
      <!-- company address info -->
        <div class="two-address-blocks">
          <div class="address-div-sw">
            <div class="addresstile footertitle"><img src="images/icons/in.svg" alt="icon" class="w32"> India</div>
            <div class="address-main">
              <address class="mt15 mb15">
                Tom Extension, 1st Block 2nd Cross, Yello circle, Jaipur, Rajasthan 123456
              </address>
          ...
          <div class="address-div-sw">
            <div class="addresstile footertitle"><img src="images/icons/us.svg" alt="icon" class="w32"> USA</div>
            <div class="address-main">
              <address class="mt15 mb15">
                Tom Extension, 1st Block 2nd Cross, Yello round circle, New York, Usa 95356
              </address>
              <div class="connectwithus sw-hover-2">
                <a href="#"><i class="fa-solid fa-tty mr10"></i> 91 123 4567 890</a>
                <a href="#"><i class="fa-solid fa-envelope mr10"></i> <span class="__cf_email__" data-cfemail="fc95929a93bc8593898e8b999e8f958899d29f9391">[email&#160;protected]</span></a>
              </div>
            </div>
          </div>
        </div>
...
<!-- Mirrored from separateweb.com/blueket-template/demo-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 20:57:59 GMT -->
</html>